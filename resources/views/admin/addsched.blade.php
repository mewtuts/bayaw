...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-white drop-shadow-lg">
        ...
        <h1 class="flex justify-center text-gray-500 text-4xl font-bold italic">Schedules</h1>
            ...
            <div class="relative w-full h-full max-w-2xl md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-3 space-y-3">
                        <form class="p-3 bg-white rounded-xl drop-shadow-lg space-y-3" action="{{ '/schedule' }}" method="POST">
                            @csrf
                            {{-- second row --}}
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full md:w-1/3 px-3">
                                    ...
                                    <select class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="subject" id="subject" required>
                                        <option value="none" disabled selected>select</option>
                                        @foreach ($subjects as $subject)
                                            <option value="{{ $subject->id }}" id="">{{ $subject->subject}} </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="w-full md:w-1/3 px-3">
                                    ...
                                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" name="start_time" type="time" required>
                                </div>
                                <div class="w-full md:w-1/3 px-3">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-middle-name">
                                    End time
                                    </label>
                                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" name="end_time" type="time" required>
                                </div> 
                                <div class="w-full md:w-1/3 px-3">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-password">
                                    Room
                                    </label>
                                    <select class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="lab_num" id="lab_num" required>
                                ...
                                <div class="w-full md:w-1/3 px-3">
                                    ...
                                    <select class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="instructor" id="user_type" required>
                                        <option value="none" disabled selected>select</option>
                                        @foreach ($instructors as $Instructor)
                                            <option value="{{ $Instructor->id }}" id="">{{ $Instructor->fname. ' '. $Instructor->lname }} </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="w-full md:w-1/3 px-3">
                                    ...
                                    <select class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="section" id="section" required>
                                        <option value="none" disabled selected>select</option>
                                ...
                                <div class="display flex justify-evenly w-full">
                                    <label>M<input type="checkbox" name="m" value="Monday"></label>
                                    <label>T<input type="checkbox" name="t" value="Tuesday"></label>
                                    <label>W<input type="checkbox" name="w" value="Wednesday"></label>
                                    <label>Th<input type="checkbox" name="th" value="Thursdays"></label>
                                    <label>F<input type="checkbox" name="f" value="Friday"></label>
                                    {{-- <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-first-name" name="day" type="checkbox" value="Monday" placeholder="" required> --}}
                                </div>
                            </div>
        ...
        <div class="overflow-y-auto shadow-md sm:rounded-lg md:w-4/5">
            <div class="flex items-center justify-between pb-4">
                {{-- add sched button --}}
                <button type="button" data-modal-target="defaultModal" data-modal-toggle="defaultModal" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 md:w-1/5">Add Schedule</button>
                    ...
                    <tbody id="myTable">
                        @foreach ($schedules as $schedule)
                            <tr class="content bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="py-3 pl-2">
                                    <a href="{{ '/schedule/delete/'.$schedule->id }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Delete</a>
...
<script>
    ...
    const inputTime = document.getElementById('start_time').value;
