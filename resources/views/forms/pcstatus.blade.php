    ...
    <div class="h-screen w-screen bg-slate-400">
        <div class="h-full w-full flex justify-center items-center">
            <div class="w-full max-w-sm p-2 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                <form class="space-y-3" action="{{ '/edit_pc/'.$lid.'/'.$pcid}}" method="post">
                    @csrf
                    ...
                    <a href="/instructor/timein" class="flex justify-center text-slate-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center underline">Cancel</a>
