        ...
        <div class="h-screen flex justify-center items-center">
            <div class="w-jomar px-3">
                <div class="w-teria min-w-full md:min-w-0text-sm shadow-lg sm:rounded-lg overflow-y-auto h-teria">
                    ...
                    @endif --}}
                    <a href="{{ '/instructor/timein' }}" class="bg-green-700 mb-5 flex justify-center text-white rounded-md py-2 text-4xl font-bold italic">Lab {{ $roomID }}</a>
                    <table class="min-w-full md:min-w-0text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            @foreach ($units as $unit)
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    <td class="italic text-blue-800 underline">
                                        <a href="{{ '/edit/instructorPC/'.$roomID.'/'.$unit->id }}">edit</a>
                                    </td>
